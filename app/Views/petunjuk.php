                                 ...
                                 <div class="row">
                                    <div class="col-md-12 col-lg-7">
                                       <div class="text-bg">
                                          <span>PETUNJUK</span>
                                          <h1>Penggunaan</h1>
                                          <p>Petunjuk penggunaan website sistem pakar perawatan harian burung murai</p>
                                       </div>
                                    </div>
      ...
      <div class="services">
         <div class="container">
            <div class="row">
               <div class="col-md-12">
                  <div class="titlepage">
                     <h2> <span class="yellow">PETUNJUK</span><br>Penggunaan</h2>
                  </div>
               </div>
               <div class="col-md-3 col-sm-6">
                  <div id="ho_color" class="services_main">
                     <i><img src="images/3.png" alt="#"/></i>
                     <img class="ho" src="images/33.png" alt="#"/>
                     <h3>Home</h3>
                     <p>Halaman awal web berisikan deskripsi-deskripsi tentang burung murai
                     </p>
                     <a class="read_more" href="/Dashboard">Read More</a>
                  </div>
               </div>
               <div class="col-md-3 col-sm-6">
                  <div id="ho_color" class="services_main">
                     <i><img src="images/2.png" alt="#"/></i>
                     <img class="ho" src="images/22.png" alt="#"/>
                     <h3>About</h3>
                     <p>Halaman About berisi tentang kami para penyusun sistem pakar perawatan burung murai
                     </p>
               ...
               <div class="col-md-3 col-sm-6">
                  <div id="ho_color" class="services_main">
                     ...
                     <img class="ho" src="images/11.png" alt="#"/>
                     <h3>Petunjuk</h3>
                     <p>Halaman Petunjuk penggunaan web Sistem Pakar perawatan burung murai
                     </p>
                     <a class="read_more" href="/Petunjuk">Read More</a>
                  </div>
               </div>
               <div class="col-md-3 col-sm-6">
                  <div id="ho_color" class="services_main">
                     <i><img src="images/4.png" alt="#"/></i>
                     <img class="ho" src="images/44.png" alt="#"/>
                     <h3>Gejala & Solusi</h3>
                     <p>Halaman tentang Tabel representasi untuk gejala dan solusi perawatan burung murai
                     </p>
                     <a class="read_more" href="/Gejala">Read More</a>
                  </div>
               </div>
            </div>
         </div>
            ...
            <div class="container">
               <div class="row">
                  <div class="col-lg-3 col-md-6 col-sm-6">
                     <a class="logo2" href="/Dashboard"><img src="images/logo12.png" alt="#"/></a>
                     <div class="follow">
                  ...
                  <div class="col-lg-3 col-md-6 col-sm-6">
                     <h3>Quick link</h3>
                     <ul class="link_icon">
                        <li> <a href="/Dashboard"> <i class="fa fa-chevron-right" aria-hidden="index.html"></i>Home</a></li>
                        <li> <a href="/About"> <i class="fa fa-chevron-right" aria-hidden="blog"></i>About </a></li>
                        <li class="active"> <a href="/Petunjuk"> <i class="fa fa-chevron-right" aria-hidden="contact"></i>Petunjuk</a></li>
                        <li> <a href="/Gejala"> <i class="fa fa-chevron-right" aria-hidden="blog"></i>Gejala & Solusi</a></li>
